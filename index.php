...
<?php include "header.php"; ?>	
		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
						<h1 class="m-b-20"><strong>Welcome To <br> Food Buddy Restaurant</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							<p>Known for our Service & Hospitality</p>
						</div>
					</div>
				</div>
			</li>
	...
	<!-- Start About -->
	<div class="about-section-box" style="margin-top: 20px;">
		<div class="container">
			<div class="row">
				<div class="col-lg-10 col-md-20 col-sm-12 text-center">
					<div class="inner-column">
						<center><h1>Welcome To <span>Food Buddy</span></h1>
						<h4>Enhancing the Experience of</h4>
						<p>Restaurants in Baramati, India</p><center>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Food Buddy</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-tava-tab" data-toggle="pill" href="#v-pills-tava" role="tab" aria-controls="v-pills-tava" aria-selected="false">Roti's</a>
					</div>
				</div>
				...
				<div class="col-9">
					<div class="tab-content" id="v-pills-tabContent">
						...
						<div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
							<div class="row">
								...
								<?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Extra'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
								<div class="col-lg-4 col-md-6 special-grid drinks">
					...
					<div class="tab-pane fade" id="v-pills-tava" role="tabpanel" aria-labelledby="v-pills-tava-tab">
							<div class="row">
								<?php include "connect.php";
								$s = mysqli_query($con,"select * from menu where category='Roti'");
								while($r = mysqli_fetch_array($s))
								{	
								?>
								<div class="col-lg-4 col-md-6 special-grid drinks">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="heading-title text-center">
                    <h2>Gallery</h2>
                    <p>Delicious food Pictures for Food Buddy Listed Here</p>
                </div>
            </div>
        </div>
        <div class="tz-gallery">
            <div class="row">
                ...
                while($r = mysqli_fetch_array($s)) {
                ?>
                <div class="col-sm-12 col-md-4 col-lg-4 gallery-image"> <!-- Added 'gallery-image' class -->
                    <img class="img-fluid" src="<?php echo "admin/".$r['image']; ?>" alt="Gallery Images" style="width: 50%; height: auto;">
                </div>
                <?php } ?>
            </div>
        </div>
