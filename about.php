			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Food Buddy resturent</span></h1>
						<h4>Little Story</h4>
						<p> Restaurants in Baramati, Baramati Restaurants 
						In our restaurant we try to provide delicious food for our consumers..
						</p>
				...
				<div class="col-md-12">
					<div class="inner-pt">
						<p style = "color : black; font : bold;"> Making way for a hearty meal is Food Buddy Restaurant in Baramati. This place is synonymous with delicious food that can satiate all food cravings. It is home to some of the most appreciated cuisines. So as to be able to cater to a large number of diners, it occupies a favorable location at Opposite Skoda Workshop, Ring Road, Baramati - 380058. Courtesy to this strategic location, foodies in and around the neighborhood can walk into this eating house conveniently without facing any hassles related to commuting to this part of the city. It is one of the most sought-after Restaurants in Baramati. This is one of the renowned Restaurants in Baramati.

 </p>
						<p style = "color : black; font : bold;">Food Buddy Restaurant at Baramati makes sure one has a great food experience by offering highly palatable food. The restaurant welcomes guests from 11:00 AM to 7:00 PM and 3:00 PM to 12:00 AM, allowing diners to relish a scrumptious meal between the functional hours. The price range of the food at the restaurant ranges from Rs. 1.
 </p>
					</div>
				</div>
			</div>
