...
<form action="loginck.php" method="post">
 ...
 <td> <input type="Password" name="pass" placeholder="Enter Your Password" style="padding: 10px; width: 150%"> <br>   </td>
		...
		<tr>	    
 <td align="right"> <input type="submit" name="" value="Login Now" style="color: Black; background-color: orange; font-size: 1.5em; font-family: times new roman;"> </td> 
</tr>
<tr> 
<td>Don't have an account click here - <a href="registration.php"> New User?</a></td>
		 </tr>
